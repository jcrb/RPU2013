...
%----------------------------------------------------------------------------- Summary
<<fig24,echo=FALSE,comment="">>=
e<-ymd_hms(d1$ENTREE)
h<-hour(e)
print("Résumé des horaires de passage:")
summary(h)
@
%---------------------------------------------------------------------- HISTOGRAMME
...
hist(h,breaks=23,xlab="Heures",main="Alsace - Horaire de fréquentation du SU",col="pink")
@
\end{center}
...
\begin{figure}
\begin{center}
<<test25, echo=FALSE,fig = TRUE,fig.height=10>>=
t<-table(h)
...
\begin{figure}
\begin{center}
  <<test2, echo=FALSE,fig = TRUE,fig.height=5>>=
...
\begin{figure}
\begin{center}
  <<test22, echo=FALSE,fig = TRUE,fig.height=5>>=
    par(mfrow = c(1, 2))
