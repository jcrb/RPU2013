...
Nombre de diagnostics principaux différents: \np{132923}

Exhaustivité des CIM10: 68.84\% \index{exhaustivité!CIM10}

Nombre de diagnostic uniques: 3993
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: input string 37807 is invalid in this locale}}\begin{alltt}
dpr$DP <- \hlkwd{gsub}(\hlstr{"+"}, \hlstr{""}, \hlkwd{as.character}(dpr$DP), fixed = TRUE)
\end{alltt}
