...
\includegraphics[width=\maxwidth]{figure/asthme23} 
\begin{kframe}\begin{verbatim}
## table(s) : 
##         Frequency Percent Cum. percent
## 3               1     2.5          2.5
