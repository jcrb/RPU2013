...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{t} \hlkwb{<-} \hlkwd{tapply}\hlstd{(}\hlkwd{as.Date}\hlstd{(d1}\hlopt{$}\hlstd{ENTREE), d1}\hlopt{$}\hlstd{FINESS, length)}
\hlstd{t}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{tru2011_lorraine} \hlkwb{<-} \hlnum{0.2345}
\hlstd{tru_estime} \hlkwb{<-} \hlstd{pop.als.2010.totale} \hlopt{*} \hlstd{tru2011_lorraine}
\hlcom{# tru2013_alsace<-round(length(e)*100/pop.als.2010.totale,2)}
\hlstd{tru2013_alsace} \hlkwb{<-} \hlkwd{round}\hlstd{(}\hlkwd{nrow}\hlstd{(d1)} \hlopt{*} \hlnum{100}\hlopt{/}\hlstd{pop.als.2010.totale,} \hlnum{2}\hlstd{)}
\hlkwd{print}\hlstd{(tru_estime)}
\end{alltt}
\begin{verbatim}
## [1] 441062
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{h} \hlkwb{<-} \hlkwd{hour}\hlstd{(d1}\hlopt{$}\hlstd{ENTREE)}
\hlstd{t} \hlkwb{<-} \hlkwd{table}\hlstd{(h)}
\hlkwd{barplot}\hlstd{(}\hlkwd{table}\hlstd{(h),} \hlkwc{xlab} \hlstd{=} \hlstr{"Heures de la journée"}\hlstd{,} \hlkwc{ylab} \hlstd{=} \hlstr{"nombre"}\hlstd{,} \hlkwc{main} \hlstd{=} \hlstr{"Répartition des RPU sur le nycthémère"}\hlstd{)}
\end{alltt}
\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: l'argument "{}X"{} est manquant, avec aucune valeur par défaut}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: there is no package called 'epitools'}}\begin{verbatim}
## [1] "Pneumonies et AGE"
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: impossible de trouver la fonction "{}colorbrewer.palette"{}}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: impossible de trouver la fonction "{}drop.levels"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: objet de type 'closure' non indiçable}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: unique() s'applique seulement aux vecteurs}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: la longueur de 'dimnames' [2] n'est pas égale à l'étendue du tableau}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: "{}align"{} must have length equal to 177 ( ncol(x) + 1 )}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: impossible de trouver la fonction "{}drop.levels"{}}}\begin{alltt}
\hlkwd{summary}\hlstd{(a)}
\end{alltt}
\begin{verbatim}
##    Length     Class      Mode 
##    132923 character character
\end{verbatim}
\begin{alltt}
...
##  2784  1438   306   789   975  4640  2600  4706  5280  9447    12  6981 
##     L     M     N     O     P     Q     r     R     S     T     V     W 
##  2683  8023  4560   157   158    55    79 20405 45176  5389   335  1215 
##     X     Y     Z  <NA> 
##   360   521  3849     0
\end{verbatim}
\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: impossible de trouver la fonction "{}drop.levels"{}}}\end{kframe}% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Fri Aug 30 15:46:00 2013
\begin{table}[ht]
\centering
\begin{tabular}{rr}
  \hline
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{n} \hlkwb{<-} \hlkwd{dim}\hlstd{(d1)}
\hlkwd{print}\hlstd{(n)}
\end{alltt}
\begin{verbatim}
## [1] 193102     20
